...
\begin{DoxyCode}{0}
\DoxyCodeLine{52     :   p(\textcolor{keyword}{nullptr})}
\DoxyCodeLine{53     \{   \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{56                          \{}
\DoxyCodeLine{57         p = make\_shared<Node>(x, \textcolor{keyword}{nullptr}, \textcolor{keyword}{nullptr});}
\DoxyCodeLine{58     \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{61                                                                     \{}
\DoxyCodeLine{62         p = make\_shared<Node>(x, \mbox{\hyperlink{class_bin_tree_a82108db4c1b08d1f111027788c196d4e}{left}}.p, \mbox{\hyperlink{class_bin_tree_aff8e96651b27284c329667b5ad3e4d0b}{right}}.p);}
\DoxyCodeLine{63     \}}
...
Definición en la línea 66 del archivo Bin\+Tree.\+hh.


\begin{DoxyCode}{0}
\DoxyCodeLine{66                         \{}
\DoxyCodeLine{67         \textcolor{keywordflow}{return} not p;}
\DoxyCodeLine{68     \}}
...
Definición en la línea 71 del archivo Bin\+Tree.\+hh.


\begin{DoxyCode}{0}
\DoxyCodeLine{71                           \{}
\DoxyCodeLine{72         assert(not \mbox{\hyperlink{class_bin_tree_a74cda259ba5c25b8ee38ed4dc33e4fad}{empty}}());}
\DoxyCodeLine{73         \textcolor{keywordflow}{return} \mbox{\hyperlink{class_bin_tree_a47eef22d29cd023449d97c073c08e5b6}{BinTree}}(p-\/>left);}
\DoxyCodeLine{74     \}}
...
Definición en la línea 77 del archivo Bin\+Tree.\+hh.


\begin{DoxyCode}{0}
\DoxyCodeLine{77                            \{}
\DoxyCodeLine{78         assert(not \mbox{\hyperlink{class_bin_tree_a74cda259ba5c25b8ee38ed4dc33e4fad}{empty}}());}
\DoxyCodeLine{79         \textcolor{keywordflow}{return} \mbox{\hyperlink{class_bin_tree_a47eef22d29cd023449d97c073c08e5b6}{BinTree}}(p-\/>right);}
\DoxyCodeLine{80     \}}
...
Definición en la línea 83 del archivo Bin\+Tree.\+hh.


\begin{DoxyCode}{0}
\DoxyCodeLine{83                             \{}
\DoxyCodeLine{84         assert(not \mbox{\hyperlink{class_bin_tree_a74cda259ba5c25b8ee38ed4dc33e4fad}{empty}}());}
\DoxyCodeLine{85         \textcolor{keywordflow}{return} p-\/>x;}
\DoxyCodeLine{86     \}}
